...
if (isset($_POST['email'])) {
    ...
    $sql = "INSERT INTO `login1`.`login1` (`email`, `password`) VALUES ('$email','$password');";   //practise- database name , signup- table name you can other names to your database and table
    echo $sql;
